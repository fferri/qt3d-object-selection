...
Entity {
    readonly property real windowWidth: surfaceSelector.surface !== null ? (Screen.devicePixelRatio * surfaceSelector.surface.width) : 0
    readonly property real windowHeight: surfaceSelector.surface !== null ? (Screen.devicePixelRatio * surfaceSelector.surface.height) : 0
...
"
    ...
    Entity {
        ...
        ObjectPicker {
            id: objectPicker
            onPressed: {
                sphereOutlineEntity.enabled = !sphereOutlineEntity.enabled
                console.log(sphereOutlineEntity.enabled)
            }
        }
        components: [ sphereMesh, material, sphereTransform, objectPicker ]
    }
